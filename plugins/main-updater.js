...
cmd({
    ...
    try {
        await reply("🔍 Checking for BOSS-MD updates...");

        // Fetch the latest commit hash from GitHub API
        const { data: commitData } = await axios.get(
            "https://api.github.com/repos/rehmanabdul78600786-ctrl/BOSS-BOTZ/commits/main"
        );
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your BOSS bot is already up-to-date!");
        }

        await reply("🚀 Updating BOSS-MD Bot...");
